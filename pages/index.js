...
import FooterContent1 from "../components/footer-content1";
...
const AppLandingPage = () => {
  return (
    <div className="w-full relative rounded-[50px] bg-white overflow-hidden flex flex-col items-start justify-start pt-10 pb-[41.3px] pr-[25px] pl-[175px] box-border gap-[115px] leading-[normal] tracking-[normal] text-left text-lg text-black font-clash-display mq750:gap-[57px] mq750:pl-[87px] mq750:box-border mq450:gap-[29px] mq450:pl-5 mq450:box-border">
      ...
      <FrameComponent />
      <div className="self-stretch flex flex-row items-start justify-center pt-0 pb-[167px] pr-0 pl-[432px] box-border max-w-full text-9xl mq750:pl-[108px] mq750:box-border mq450:pb-[109px] mq450:box-border mq1050:pl-[216px] mq1050:box-border">
      ...
      <div className="self-stretch flex flex-row items-start justify-center pt-0 pb-[141.7px] pr-0 pl-[264px] box-border max-w-full mq750:pl-[66px] mq750:box-border mq450:pl-5 mq450:pb-[60px] mq450:box-border mq1050:pl-[132px] mq1050:pb-[92px] mq1050:box-border">
      ...
      <main className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px]">
        ...
        <img
          ...
          alt=""
          src="/bottom-feature-blur@2x.png"
        />
        <img
        ...
        />
        <img
          className="absolute top-[3522px] left-[871px] w-10 h-10 object-contain z-[8]"
          loading="lazy"
          alt=""
          src="/group-28@2x.png"
        />
        <div className="absolute top-[3527px] left-[919px] w-36 h-[30px] opacity-[0.5] z-[8]">
          <img
        ...
        <div className="absolute top-[3077px] left-[128px] w-[713px] h-[713px]">
          <div className="absolute top-[261.7px] left-[69px] w-[327px] h-[237.3px] flex items-center justify-center">
            <img
        ...
        />
        <img
          className="absolute top-[3702.7px] left-[48px] w-[67.9px] h-[67.9px] object-contain z-[8]"
          loading="lazy"
          alt=""
          src="/star-2.svg"
        />
